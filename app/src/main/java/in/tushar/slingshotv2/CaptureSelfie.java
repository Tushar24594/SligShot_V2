...
public class CaptureSelfie extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PictureCallback  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (surfaceView != null) {
            ...
            if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(CaptureSelfie.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 3);
            }
    ...
    private void requestPermissions(String[] permissions) {
        ActivityCompat.requestPermissions(CaptureSelfie.this, permissions, REQUEST_CODE);
    }
